...
Based on php:8.4.16-fpm-alpine3.23, node:25.2.1-alpine3.23 (nodejs is not included in most of other nginx-php images...but needed by a lot of php frameworks), with nginx:alpine and richarvey/nginx-php-fpm's Docker script
...
**Tags:**
* latest, php8.4.16_node25.2.1, php8.4.16_withoutNodejs (2026-01-14 alpine3.23)
...
```
# php -v
PHP 8.4.16 (cli) (built: Jan  9 2026 22:46:17) (NTS)
